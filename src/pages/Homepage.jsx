    ...
    return (
        <>
            <motion.div className="h-screen w-full relative">
                ...
                <motion.div className='flex h-screen w-full absolute top-0 left-0 z-1'>
                    <motion.div className='flex flex-col h-full w-[60vw] justify-center ml-32'>
                        ...
                        >
                        <motion.p variants={leftAnimate} className="p-4 z-30  xl:text-6xl md:text-5xl text-gray-800" style={{ fontFamily: 'Literata, serif', fontWeight: 800 }}>Welcome to
                        ...
                        >
                        <motion.p variants={leftAnimate} className=" p-4 z-30 md:text-2xl xl:text-3xl text-gray-800" style={{ fontFamily: 'Literata, serif', fontWeight: 800 }}>your gateway to immersive language learning!
                        </motion.p>
                        </motion.div>
                        <motion.div
                        initial={"offscreen"}
                        ...
                        >
                        <motion.p variants={leftAnimate} className="p-4 z-30 md:text-xl xl:text-2xl" style={{ fontFamily: 'Literata, serif', fontWeight: 500, color: '#7D7D7D' }}>Whether you're a beginner or aiming for fluency,<br /> LinguaVerse offers a unique blend of engaging<br /> features to guide you towards mastery.
                        </motion.p>
                        </motion.div>
                        <motion.div className="p-4 z-40 md:text-4xl xl:text-5xl my-4" style={{ fontFamily: 'Literata, serif', fontWeight: 1000, color: '#3A3148', height: '80px' }} ref={el}></motion.div>
                        <motion.div
                        initial={"offscreen"}
                        whileInView={"onscreen"}
                        viewport={{ once: true, amount: 0.5 }}
                        ...
                        <motion.p variants={leftAnimate} className="p-4 z-40">
                            <button {...shimmerComponent.component.props} onClick={handleClick} style={{ fontFamily: 'Literata, serif'}}>
            ...
            <motion.div className="">
                <motion.div className="custom-gradient h-screen flex flex-col justify-center items-center w-full relative" style={{ height: '900px' }}>
                    ...
                    <motion.div
                        ...
                        style={{ width: "600px", height: "406px" }}>
                            <img src={video_call} alt="study" className="absolute object-cover object-bottom z-20 mr-8" width="400" height="276" />
                        </motion.div>
                        <motion.div
                        initial={"offscreen"}
                        whileInView={"onscreen"}
            ...
            <motion.div className="">
                <motion.div className="h-screen flex flex-col justify-center items-center w-full relative" style={{ height: '900px' }}>
