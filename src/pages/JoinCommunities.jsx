...
const JoinCommunities = () => {
  ...
  return (
    <div className=' relative custom-gradient4 h-screen w-full flex flex-col justify-evenly items-center'>
      ...
      <button className='bg-white text-[#60359E] text-3xl font-bold rounded-lg shadow-lg px-4 py-3 mt-8 hover:font-extrabold hover:bg-slate-50 hover:shadow-xl transition-all duration-300' style={{ fontFamily: 'Literata, serif', width: "15%" }} onClick={handleClick}>Next</button>
    </div>
  );
};
